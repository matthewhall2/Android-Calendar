...
public class DialogSelectEventDateTime extends AppCompatDialogFragment implements PopupMenu.OnMenuItemClickListener {
    private CalendarView calendarView;
    private DialogSelectEventDateTime.DateDialogListener lsitener;
